                ...
                <div class="sidebar left-sidebar">
                    ...
                    <div class="s-side-text">
                        <div class="banner clearfix">
                            <a href="#"><img src="{{ asset('frontend/img/products/banner.jpg') }}" alt="" /></a>
                        ...
                        <div class="tab-content grid-content">
                            <div class="tab-pane fade in active text-center" id="grid">
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="#"><img src="{{ asset('frontend/img/products/9.jpg') }}" alt="Product Title" /></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="#"><img src="{{ asset('frontend/img/products/2.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="#"><img src="{{ asset('frontend/img/products/8.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="#"><img src="{{ asset('frontend/img/products/12.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="#"><img src="{{ asset('frontend/img/products/11.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="#"><img src="{{ asset('frontend/img/products/14.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="#"><img src="{{ asset('frontend/img/products/15.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                ...
                                <div class="col-xs-12 hidden-sm col-md-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="#"><img src="{{ asset('frontend/img/products/10.jpg') }}" alt="Product Title" /></a>
                                            <div class="actions-btn">
                                                <a href="#"><i class="mdi mdi-cart"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
                                                <a href="#"><i class="mdi mdi-heart"></i></a>
                                        ...
                                        <div class="quick-image">
                                                ...
                                                <div class="list-img">
                                                    <div class="product-img tab-content">
                                                        <div class="simpleLens-container tab-pane fade in" id="q-sin-1">
                                                            ...
                                                            <a class="simpleLens-image" data-lens-image="img/products/z1.jpg') }}" href="#"><img src="{{ asset('frontend/img/products/z1.jpg') }}" alt="" class="simpleLens-big-image"></a>
                                                        </div>
                                                        <div class="simpleLens-container tab-pane active fade in" id="q-sin-2">
                                                            <div class="pro-type sell">
                                                                <span>sell</span>
                                                            </div>
                                                            <a class="simpleLens-image" data-lens-image="img/products/z2.jpg') }}" href="#"><img src="{{ asset('frontend/img/products/z2.jpg') }}" alt="" class="simpleLens-big-image"></a>
                                                        </div>
                                                        <div class="simpleLens-container tab-pane fade in" id="q-sin-3">
                                                            <div class="pro-type">
                                                                <span>-15%</span>
                                                            </div>
                                                            <a class="simpleLens-image" data-lens-image="img/products/z3.jpg') }}" href="#"><img src="{{ asset('frontend/img/products/z3.jpg') }}" alt="" class="simpleLens-big-image"></a>
                                                        </div>
                                                        <div class="simpleLens-container tab-pane fade in" id="q-sin-4">
                                                            <div class="pro-type">
                                                                <span>new</span>
                                                            </div>
                                                            <a class="simpleLens-image" data-lens-image="img/products/z4.jpg') }}" href="#"><img src="{{ asset('frontend/img/products/z4.jpg') }}" alt="" class="simpleLens-big-image"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="quick-thumb">
                                                <ul class="product-slider">
                                                    <li><a data-toggle="tab" href="#q-sin-1"> <img src="{{ asset('frontend/img/products/s1.jpg') }}" alt="quick view" /> </a></li>
                                                    <li class="active"><a data-toggle="tab" href="#q-sin-2"> <img src="{{ asset('frontend/img/products/s2.jpg') }}" alt="small image" /> </a></li>
                                                    <li><a data-toggle="tab" href="#q-sin-3"> <img src="{{ asset('frontend/img/products/s3.jpg') }}" alt="small image" /> </a></li>
                                                    <li><a data-toggle="tab" href="#q-sin-4"> <img src="{{ asset('frontend/img/products/s4.jpg') }}" alt="small image" /> </a></li>
                                                </ul>
                                            </div>
                                        </div>						
                                    </div>
