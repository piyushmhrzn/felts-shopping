...
@section('header')
  <a class="navbar-brand">Super Admin Settings / Add Admin</a>
@endsection
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-md-8 col-sm-10">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form" action="{{route('storeAdmin')}}" method="post" enctype="multipart/form-data" role="form" autocomplete="off" data-parsley-validate>
            @csrf
              <!--- Admin First Name -->
